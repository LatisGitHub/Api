...
class VistaSong
{
    ...
    <head>
        ...
        <script>
        let sonido = new Audio("img/Earl Sweatshirt - Old Friend.mp3");
        sonido.play();
        sonido.volume = 0.2;
    </script>
        </head>
    ...
    <div class="container">
        ...
        echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3" style="border-radius: 5px ;">
            ...
            <a class="navbar-brand text-light" href="enrutador.php?accion=mostrarTop">API MUSICA</a>
       ...
       $guzzle = new GuzzleHttp\Client(['base_uri' => '3.144.143.217:3000']);
        $response = $guzzle->get('crear-api/song', [
...
echo "<CENTER><h3 class='mb-4 mt-2'> SONGS </h3><CENTER>";    
